...
baseUrl_value = "https://tuoitre.vn";


def crawNewsData(baseUrl, url):
    # function crawNewsData ->
    # baseUrl: duong dan goc
    # url: duong dan parse tu khi tinh chinh du lieu
    #
...
dataResult = crawNewsData(baseUrl_value, url_value);
print(dataResult);
